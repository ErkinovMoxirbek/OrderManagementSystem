...
VALUES
    ('1e9b4f30-1234-4567-890a-abcdef123456', 'John Doe', 'doe@example.com', '123', 'ACTIVE', 'CUSTOMER', true, NOW()),

    ('2a7c8e20-2345-5678-901b-bcdefa234567', 'Jane Smith', 'smith@example.com', '123', 'ACTIVE', 'ADMIN', true, NOW()),

    ('3b8d9f10-3456-6789-012c-cdefab345678', 'Bob Johnson', 'bob@example.com', '123', 'NOACTIVE', 'CUSTOMER', false, NOW());
